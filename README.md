...
#远程操作
	...
	如果一切顺利的话，可以在用户主目录里找到.ssh目录，里面有id_rsa和id_rsa.pub两个文件，这两个就是SSH Key的秘钥对，id_rsa是私钥，不能泄露出去，id_rsa.pub是公钥，可以放心地	
	告诉任何人。

	点“Add SSH Key”，填上任意Title，在Key文本框里粘贴id_rsa.pub文件的内容即可


	$ git remote add origin git@github.com:betrs/project.git  本地仓库与github仓库关联
...
#远程克隆
	...
	$ git clone git@github.com:betrs/project.git  从github上克隆一个项目到本地
